...
const buttonVariants = cva(
    "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 text-sm font-medium whitespace-nowrap transition-all outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
    {
        variants: {
            variant: {
                default:
                    "bg-primary text-white shadow-[0_4px_14px_rgba(124,110,230,0.35)] hover:shadow-[0_6px_20px_rgba(124,110,230,0.45)] hover:bg-[#6b5cd3] hover:-translate-y-0.5 active:scale-[0.98] transition-all duration-300 rounded-none font-semibold",
                destructive:
                    "bg-destructive text-white hover:bg-destructive/90 transition-all duration-300 rounded-none font-semibold",
                outline:
                ...
                ghost: "hover:bg-primary/10 hover:text-primary transition-colors duration-200 rounded-none font-semibold",
