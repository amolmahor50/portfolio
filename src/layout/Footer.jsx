...
const Footer = () => {
    ...
    return (
        <footer className="w-full bg-white border-t border-gray-200/80 pt-16 pb-12 px-4 md:px-8">
            ...
            <div className="max-w-6xl mx-auto mb-16 p-8 md:p-12 rounded-none bg-linear-to-r from-primary via-secondary to-accent text-white text-center shadow-xl shadow-primary/20 space-y-6">
                ...
                <p className="text-white/90 text-base max-w-xl mx-auto font-medium">
                    Let's collaborate to bring your ideas to life with modern architecture, high
                    performance, and exceptional UI/UX.
                </p>
                <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                    <Button size="lg" variant="outline" className="md:w-fit w-full">
            ...
            <PageLayout className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 mb-12">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-gray-500 text-base leading-relaxed max-w-xs">
                        Crafting high-performance web applications with modern architecture, clean
                        code, and user-centric designs.
                    </p>
            ...
            {/* COPYRIGHT BOTTOM */}
            <PageLayout>
                <div className="md:pt-8 pt-3 border-t border-gray-200/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-gray-500 text-center sm:text-left">
                    <p>© {new Date().getFullYear()} Amol Mahor. All rights reserved.</p>
                </div>
            </PageLayout>
        </footer>
    );
