...
import { skillsList, toolsData } from "@/utils/data";
...
const Skills = () => {
  ...
  const filteredSkills =
    activeCategory === "all" ? skillsList : skillsList.filter((s) => s.category === activeCategory);
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-base text-gray-500 leading-relaxed">{skill.desc}</p>
                  </div>
        ...
        <section className="pt-6 text-center">
          <div className="p-8 md:p-12 bg-white border border-gray-200/90 shadow-xs flex flex-col items-center space-y-4 max-w-3xl mx-auto relative overflow-hidden">
            ...
            <p className="text-base text-gray-500 max-w-xl">
              Whether you need an enterprise admin panel, custom full-stack application, or
              real-time feature, let's discuss your requirements.
            </p>
