...
const Contact = () => {
    ...
    const { mutateAsync: sendMessage, isPending: submitting } = useSendMessage();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setStatus({
                type: "success",
                text: "Thank you! Your message has been securely delivered and recorded.",
            });
            ...
            setStatus({
                type: "error",
                text: "Failed to send your message. Please try again or reach out directly by email.",
            });
        }
    };
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
                ...
                <div className="bg-white shadow-xs border border-gray-200/90 rounded-none h-full relative overflow-hidden">
                    ...
                    >
                        ...
                        {status && (
                            <div
                                className={`p-4 rounded-none text-sm font-medium flex items-center gap-2.5 ${
                                    status.type === "success"
                        ...
                        <div className="relative group/field">
                            <input
                                ...
                                type="text"
                                name="subject"
                                placeholder="Subject (e.g. Project Inquiry, Full Stack Role)"
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="bg-primary text-white hover:bg-primary/90 transition-colors w-full py-3.5 text-sm md:text-base font-semibold flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {submitting ? (
                                <>
