    ...
    return (
        <>
            <div className="md:pt-14 md:space-y-20 space-y-10 relative">
                ...
                {/* Header Section */}
                <Headline
                    badge={<><MessageSquare size={16} /><span className="text-xs font-semibold uppercase tracking-tight leading-none">Get In Touch</span></>}
                    title="Let's Start a"
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
                    ...
                    <div className="bg-white shadow-xs border border-gray-200/90 rounded-none h-full relative overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 md:p-10 p-7 relative overflow-hidden group">
                            ...
                            <div className="relative group/field">
                                <textarea
                                    ...
                                    name="message" placeholder="Start typing your message..."
                                    value={formData.message} onChange={handleChange} required
                                />
                            </div>

                            <button type="submit" className="btn-primary w-full py-3.5 text-sm md:text-base font-semibold">
...
const inputStyles = "w-full px-4 py-3 text-sm md:text-base bg-gray-50/50 border border-gray-200 text-gray-900 focus:outline-none focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/20 transition-all duration-300 placeholder:text-gray-400 font-normal rounded-none";