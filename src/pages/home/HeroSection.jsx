...
const HeroSection = () => {
    ...
    return (
        <section className="relative flex items-center overflow-hidden w-full py-10 md:py-20">
            ...
            <div className="w-full max-w-4xl mx-auto px-4 md:px-8 text-center flex flex-col items-center space-y-6 md:space-y-8">
                ...
                {/* STATUS BADGE */}
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-none bg-primary/10 border border-primary/20 text-primary">
                ...
                <p className="text-base md:text-lg text-gray-600 leading-relaxed font-normal max-w-2xl mx-auto">
                    Full Stack Developer with 2+ years of production experience building enterprise platforms like SuperLeader, PollPandit, and HRMS dashboards with React.js, Node.js, and modern cloud stacks.
                </p>
