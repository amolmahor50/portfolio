...
const Home = () => {
    ...
    const impactStats = [
        { label: "Production Experience", value: "2+ Years", detail: "Strelema & UC Services" },
        { label: "Commercial Projects", value: "15+", detail: "Deployed & Maintained" },
        { label: "Admin & HRMS Dashboards", value: "10+", detail: "Engineered with RBAC" },
        { label: "System Reliability", value: "99.9%", detail: "High-throughput APIs" },
    ];
    ...
    return (
        <div className="space-y-20 md:space-y-32">
            ...
            {/* IMPACT METRICS BAR */}
            <section className="bg-white border border-gray-200/90 shadow-xs p-6 md:p-8">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
                    {impactStats.map((stat, i) => (
                        <div key={i} className="text-center space-y-1.5 pt-4 lg:pt-0">
                            <h3 className="text-2xl sm:text-2xl md:text-3xl font-semibold text-gray-900 tracking-tight">
                                {stat.value}
                            </h3>
            ...
            <section className="space-y-12">
                <Headline
                    badge={<><Briefcase size={16} /><span className="text-xs font-semibold uppercase tracking-tight">Engineering Background</span></>}
                    title="Engineering"
            ...
            <section className="space-y-12">
                <Headline
                    badge={<><Sparkles size={16} /><span className="text-xs font-semibold uppercase tracking-tight">Services &amp; Offerings</span></>}
                    title="What I Can"
            ...
            <section id="featured-projects" className="space-y-12 scroll-mt-24">
                <Headline
                    badge={<><Briefcase size={16} /><span className="text-xs font-semibold uppercase tracking-tight">Production Track Record</span></>}
                    title="Featured"
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        {project.live && project.live !== "#" && (
                                            <a
                                                ...
                                                rel="noreferrer"
                                                className="p-1.5 text-gray-400 hover:text-primary hover:bg-primary/10 border border-transparent hover:border-primary/20 transition-all"
                                                title={project.type?.includes("Website") ? "Open Live Website" : "Open Live Platform"}
                                            >
                            ...
                            <div className="space-y-4 pt-4 border-t border-gray-100">
                                <div className="flex items-center justify-between">
                                    ...
                                    {project.live && project.live !== "#" ? (
                                        ...
                                        >
                                            <span>{project.actionText || (project.type?.includes("Website") ? "Visit Website" : "Visit Live")}</span>
            ...
            <section className="space-y-12">
                <Headline
                    badge={<><Star size={16} className="text-amber-500 fill-amber-500" /><span className="text-xs font-semibold uppercase tracking-tight">Team &amp; Peer Endorsements</span></>}
