    ...
    return (
        <>
            <div className="pt-6 md:pt-20 space-y-20 md:space-y-28 relative overflow-hidden">
                ...
                <Headline
                    badge={<><Zap size={16} /><span className="text-xs font-semibold uppercase tracking-tight">Engineering Value</span></>}
                    title="Services &"
                    ...
                    {servicesData.map((service, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* LEFT CONTENT */}
                                <div className={`space-y-6 flex flex-col justify-center ${!isEven ? "lg:order-2" : ""}`}>

                                    <div className="flex items-center gap-3">
                                        <div
                                            className={`p-2 w-max rounded-none border ${
                                                index % 3 === 0
                                        ...
                                        {service.badge && (
                                            <span className="px-3 py-1 text-xs font-bold uppercase tracking-wider bg-primary/10 border border-primary/20 text-primary">
                                                {service.badge}
                                            </span>
                                        )}
                                    </div>
                                ...
                                <div className={`flex items-center ${!isEven ? "lg:order-1" : ""}`}>
                                    <div className="w-full bg-white border border-gray-200/90 rounded-none p-6 md:p-8 shadow-xs hover:shadow-xl hover:border-primary/40 transition-all duration-300 relative overflow-hidden flex flex-col justify-between space-y-6">
                                        {/* Top Accent Line */}
                                        <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-primary via-secondary to-accent" />

                                        {/* Card Header */}
                                        <div className="flex items-center justify-between border-b border-gray-100 pb-4">
                                            <div className="flex items-center gap-2 text-gray-900 font-bold text-base md:text-lg">
                                                <Layers size={18} className="text-primary" />
                                                <span>Deliverables & Tech Stack</span>
                                            </div>
                                            <span className="inline-flex items-center gap-1 text-xs font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 px-2.5 py-1">
                                                <Sparkles size={12} />
                                                Ready to Build
                                            </span>
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <ul className="space-y-2">
                                                {service.deliverables ? (
                                                    ...
                                                    <li className="text-sm text-gray-500">Customized roadmap and sprint execution</li>
                                                )}
                                            </ul>
                                        </div>
                                        ...
                                        <div className="pt-2">
                                            <Link
                                                to="/contact"
                                                className="btn-primary w-full text-center py-2.5 text-xs md:text-sm font-semibold rounded-none flex items-center justify-center gap-2"
                                            >
                ...
                <section className="mt-12">
                    ...
                    {/* CTA */}
                    <div className="text-center flex mt-12 justify-center">
