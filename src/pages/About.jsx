    ...
    return (
        <>
            <div className="md:pt-10 space-y-10 md:space-y-32">
                {/* Profile Section */}
                <div
                    className="flex justify-between md:flex-row flex-col gap-16 items-center"
                >

                    <div className="space-y-4">
                        <div className="inline-flex items-center space-x-2 px-4 py-1.5 rounded-none bg-primary/10 border border-primary/20 text-primary">
                            <User size={16} />
