                ...
                <div className="flex justify-between md:flex-row flex-col gap-16 items-center">
                    <div className="space-y-4">
                        ...
                        <p className="leading-relaxed text-base text-gray-600">
                            ...
                            experience engineering scalable web applications and enterprise
                            platforms. Currently at{" "}
                            <strong className="text-gray-900 font-semibold">Strelema</strong>, I
                            develop mission-critical platforms including{" "}
                            <strong className="text-gray-900 font-semibold">SuperLeader</strong>,
                            enterprise HRMS dashboards, and data-driven polling engines like{" "}
                            <strong className="text-gray-900 font-semibold">PollPandit</strong>.
                        </p>
                        <p className="leading-relaxed text-base text-gray-600">
                            Specializing in React.js, Node.js, PostgreSQL, Express.js, and
                            Socket.io, I architect resilient backends, implement granular role-based
                            access control (RBAC), and deliver pixel-perfect user interfaces built
