...
// icons
import { ExternalLink, Github, Filter, MoveRight } from "lucide-react";
    ...
    return (
        <>
            <div className="pt-6 md:pt-14 space-y-12 md:space-y-24">
                ...
                <Headline
                    badge={<><Filter size={16} /><span className="text-xs font-medium uppercase tracking-tight">Portfolio Showcase</span></>}
                    title="Digital"
                    ...
                    {projectsData.map((project) => (
                        ...
                        >
                            <div>
                                ...
                                <p className="text-gray-500 text-sm md:text-base line-clamp-3 mb-5 md:mb-8">
                                    {project.description}
                                </p>
